...
Enhance milestone planning with specialized AI personas:

```bash
# Architecture analysis for system design
/project:simone:create_milestone "User Authentication System" --persona-architect --persona-security

# Comprehensive analysis for critical milestones
/project:simone:create_milestone "Payment Gateway" --persona-security --persona-backend --consensus
```

**Benefits**: OWASP compliance validation, technical feasibility assessment, risk identification, effort estimation refinement.
